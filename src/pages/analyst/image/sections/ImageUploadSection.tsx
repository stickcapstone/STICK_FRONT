    ...
    return (
      ...
      >
        ...
        <p className="text-sm font-semibold text-text">
          {dragging ? "여기에 파일을 놓아주세요" : "클릭하거나 이미지를 끌어오세요"}
        </p>
        <p className="font-mono text-[11px] tracking-[0.08em] text-muted">JPG, PNG, 최대 20MB</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="relative flex max-h-[280px] items-center justify-center overflow-hidden rounded-3xl border border-border bg-panel">
        <img alt="preview" className="block max-h-[280px] w-full object-contain" src={preview} />
        <button
