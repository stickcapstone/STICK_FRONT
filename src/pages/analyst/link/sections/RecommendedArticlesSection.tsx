import type { RecommendedArticle } from "../../../../data/data";

interface RecommendedArticlesSectionProps {
  articles: RecommendedArticle[];
}

export default function RecommendedArticlesSection({ articles }: RecommendedArticlesSectionProps) {
  return (
